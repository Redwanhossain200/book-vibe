    ...
    <div className="bg-transparent backdrop-blur-lg sticky top-0 z-50">
      <nav className="navbar container mx-auto py-4 px-4 lg:px-0">
        <div className="navbar-start">
          ...
          <a className="text-2xl md:text-3xl font-extrabold text-[#131313] cursor-pointer">
            Book Vibe
          </a>
        </div>
        ...
        <div className="navbar-end gap-2 md:gap-4">
          <button className="btn bg-[#23BE0A] hover:bg-[#1fa308] text-white rounded-3xl border-none min-h-0 h-10 md:h-12 px-4 md:px-7 text-sm md:text-lg">
            Sign In
          </button>
          <button className="btn bg-[#59C6D2] hover:bg-[#4ab5c1] text-white rounded-3xl hover:text-black border-none min-h-0 h-10 md:h-12 px-4 md:px-7 text-sm md:text-lg">
            Sign Up
          </button>
        </div>
      </nav>
